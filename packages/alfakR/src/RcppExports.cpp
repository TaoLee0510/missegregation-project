...
// run_karyotype_abm
Rcpp::List run_karyotype_abm(Rcpp::List initial_population_r, Rcpp::List fitness_map_r, double p_missegregation, double dt, int n_steps, long long max_population_size, double culling_survival_fraction, int record_interval, int seed, Rcpp::NumericMatrix grf_centroids, double grf_lambda, Rcpp::IntegerVector lower_copy_numbers, Rcpp::IntegerVector upper_copy_numbers, Rcpp::CharacterVector excluded_karyotypes);
RcppExport SEXP _alfakR_run_karyotype_abm(SEXP initial_population_rSEXP, SEXP fitness_map_rSEXP, SEXP p_missegregationSEXP, SEXP dtSEXP, SEXP n_stepsSEXP, SEXP max_population_sizeSEXP, SEXP culling_survival_fractionSEXP, SEXP record_intervalSEXP, SEXP seedSEXP, SEXP grf_centroidsSEXP, SEXP grf_lambdaSEXP, SEXP lower_copy_numbersSEXP, SEXP upper_copy_numbersSEXP, SEXP excluded_karyotypesSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type lower_copy_numbers(lower_copy_numbersSEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerVector >::type upper_copy_numbers(upper_copy_numbersSEXP);
    Rcpp::traits::input_parameter< Rcpp::CharacterVector >::type excluded_karyotypes(excluded_karyotypesSEXP);
    rcpp_result_gen = Rcpp::wrap(run_karyotype_abm(initial_population_r, fitness_map_r, p_missegregation, dt, n_steps, max_population_size, culling_survival_fraction, record_interval, seed, grf_centroids, grf_lambda, lower_copy_numbers, upper_copy_numbers, excluded_karyotypes));
...
static const R_CallMethodDef CallEntries[] = {
    {"_alfakR_run_karyotype_abm", (DL_FUNC) &_alfakR_run_karyotype_abm, 14},
